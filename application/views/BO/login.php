...
<body class="container">
    ...
    <div class="form-group">
        <form action="<?php echo base_url() ?>Admin/Login/connect" method="post">
	        <div class="form-group">
...
<!--   Core JS Files   -->
<script src="<?php  echo base_url() ?>BO-Assets/js/jquery-1.10.2.js" type="text/javascript"></script>
<script src="<?php  echo base_url() ?>BO-Assets/js/bootstrap.min.js" type="text/javascript"></script>

<!--  Checkbox, Radio & Switch Plugins -->
<script src="<?php  echo base_url() ?>BO-Assets/js/bootstrap-checkbox-radio.js"></script>

<!--  Charts Plugin -->
<script src="<?php  echo base_url() ?>BO-Assets/js/chartist.min.js"></script>

<!--  Notifications Plugin    -->
<script src="<?php  echo base_url() ?>BO-Assets/js/bootstrap-notify.js"></script>

<!-- Paper Dashboard Core javascript and methods for Demo purpose -->
<script src="<?php  echo base_url() ?>BO-Assets/js/paper-dashboard.js"></script>

<!-- Paper Dashboard DEMO methods, don't include it in your project! -->
<script src="<?php  echo base_url() ?>BO-Assets/js/demo.js"></script>
</html>